...
emph
The input variables of the other-daughters-BDT are:  \emph{trk\_llr\_pid\_score},\emph{trk\_distance},\emph{trk\_score},\emph{pfp\_generation},\emph{Number of daughters of the particle}.
