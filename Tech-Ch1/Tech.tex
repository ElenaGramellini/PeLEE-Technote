...
\begin{itemize}
    ...
    \item \textbf{Cosmic}: Events from MC overlay where a cosmic instead of a neutrino interaction has been selected as the neutrino candidate by Pandora's \texttt{SliceID}.
...
\par As of January 2020,  all of the latest samples are used, including the ``GENIE-TUNE CV" weights for work through the development of the selections.
