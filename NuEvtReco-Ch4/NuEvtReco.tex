...
\textcolor{blue}{ \st{This has the main advantage of modeling all of these effects,  to the best of our knowledge}}. 
...
Any \textcolor{blue}{mis-modeling \st{imperfection}} in the simulation used to build the likelihood produces a loss of power \textcolor{blue}{in data, so the likelihood response is validated in data sidebands and control regions. \st{but does not add any systematic uncertainty}}.
In a sample of contained protons and muons used to test the performance, this PID variable is able to reach 94\% muon efficiency, with 10\% proton mis-ID rate.
