...
\begin{center}
    ...
    \end{subfigure}
\caption{\label{fig:nuereco} Left Efficiency of the \texttt{SliceID} (black) and shower-requirement (blue) for $\nu_e$ events. Center: data-MC comparison after \texttt{SliceID}. Right: data-MC comparison after shower requirement. }
\end{center}
\end{figure}
