...
\textcolor{blue}{Some of the citation links are broken}
...
\end{itemize}
An additional detector effects that needs to be accounted for are ion Recombination which impacts the detector's calorimetric response. Tailored studies and proton samples are being developed to assess ion recombination modeling accuracy in MCC9. \textcolor{blue}{if we don't have the ion recombination, this should go in italics -- Elena}
