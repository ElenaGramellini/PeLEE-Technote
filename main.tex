...
\par \noindent \textbf{Flux and Cross-Section Modeling}
...
$i$-th bin of the $k$-th universe and $N_i^{CV}$ is that of the central value.
...
RPA\_CCQE\_Genie       & RPA-based calculation on Genie CCQE model & 2\\ 
Theta\_Delta2Npi\_Genie       &  pion angle distribution (resonant events) & 2\\ 
VecFFCCQEshape\_Genie      &  CCQE vector form factor model & 2\\  
XSecShape\_CCMEC\_Genie     &  Charge-current MEC cross section model & 2\\ 
\hline
\end{tabular}
