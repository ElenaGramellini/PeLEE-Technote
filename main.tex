...
%\begin{comment}
\include{Sidebands/sidebands}
%\end{comment}

\begin{comment}
\include{Fakedata/fakedata}
\end{comment}
...
\input{Appendix/pi0.tex}

\newpage

\include{Appendix/1eNp}

\newpage

\include{Appendix/1e0p}

\newpage

\include{Appendix/nueincl}

\newpage

\input{Appendix/numucc.tex}

\newpage

\include{Appendix/stopping_muon_protons_sideband_integral}

\newpage

\include{Appendix/sensitivity_appendix}
...
\include{Sidebands/datasidebandplotdumps}

\newpage

\begin{comment}
\include{Fakedata/fakedataappendix}
\end{comment}

\newpage

\include{Appendix/dataerrorbars}
