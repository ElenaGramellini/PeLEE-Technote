...
\subsubsection{$e$/$\gamma$ Separation \textcolor{red}{David}}
...
\subsection{Detector Systematics \textcolor{red}{Maya}}
...
\subsection{Neutrino Interaction Modeling Uncertainties \textcolor{red}{Maya}}
...
\subsection{Hadronic Reinteraction Uncertainties \textcolor{red}{Maya}}
...
As have been discussed before, we have shown that we have a  well-reconstructed nue and numu selection. All the selections share the same neutrino flux and cross-section and therefore the measurements between them are highly correlated. We can exploit these correlations to reduce the systematics uncertainties when performing the combined side-by-side fit of the different channel for the sensitivity results.

The different selections described in Section~\ref{sec:nueselection:variables}-\ref{section:numu} provide constraints to different energy range of the 1eNp selection as well as the kinematics and topology.
